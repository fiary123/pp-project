...
包含: 用户、宠物(30条)、社区帖子(25条)、评论、公告、领养申请
"""
import sys
import os
import json
...
# 种子数据使用明文密码（兼容 auth_service 中的明文回退逻辑）
...
# ── 用户数据 ────────────────────────────────────────────────────────────────
USERS = [
    {"username": "用户A", "email": "user@test.com",  "password": "123456", "role": "individual"},
    {"username": "爱宠救助站", "email": "admin@test.com", "password": "admin123", "role": "org_admin"},
    {"username": "系统管理员", "email": "root@test.com",  "password": "root123",  "role": "root"},
    {"username": "喵星人控",   "email": "miao@test.com",  "password": "123456",   "role": "individual"},
    {"username": "汪星球",     "email": "wang@test.com",  "password": "123456",   "role": "individual"},
    {"username": "宠物医院",   "email": "vet@test.com",   "password": "vet123",   "role": "org_admin"},
    {"username": "萌宠爱好者", "email": "fan@test.com",   "password": "123456",   "role": "individual"},
    {"username": "橘猫饲主",   "email": "jucat@test.com", "password": "123456",   "role": "individual"},
]
...
PETS = [
    ...
    },
    {
        ...
        "tags": ["折耳", "呆萌", "温和"], "image": CAT_IMAGES[8], "owner_id": 2,
    },
    {
        "name": "虎纹", "species": "美国短毛猫", "age": 5,
        "is_shedding": "适量", "energy_level": "中等",
        "description": "经典银色虎纹，身体健壮。已绝育，打过全套疫苗。性格随和，和小孩相处融洽。",
        "tags": ["虎纹", "已绝育", "亲小孩"], "image": CAT_IMAGES[9], "owner_id": 6,
    },
    {
        "name": "糖糖", "species": "缅因猫", "age": 2,
        "is_shedding": "较多", "energy_level": "活跃",
        "description": "大型猫种，毛发厚实蓬松，像个小狮子。性格温柔像狗狗一样忠诚，会跟着主人走。",
        "tags": ["大型", "温柔", "像狗的猫"], "image": CAT_IMAGES[0], "owner_id": 2,
    },
    {
        "name": "蓝莓", "species": "俄罗斯蓝猫", "age": 1,
        "is_shedding": "少", "energy_level": "中等",
        "description": "蓝灰色短毛，绿色眼睛，气质高冷。对陌生人有些警惕，但和熟悉的人非常亲近。",
        "tags": ["高冷", "绿眼", "低敏感"], "image": CAT_IMAGES[1], "owner_id": 2,
    },
    {
    ...
    {
        "name": "可乐", "species": "无毛猫", "age": 2,
        "is_shedding": "无", "energy_level": "活跃",
        "description": "斯芬克斯无毛猫，皮肤温热柔软，像个小暖炉。对过敏人群友好，性格热情爱撒娇。",
        "tags": ["无毛", "低过敏", "热情"], "image": CAT_IMAGES[4], "owner_id": 2,
    },
    # 狗狗 (15条)
    {
        "name": "球球", "species": "金毛寻回犬", "age": 2,
        "is_shedding": "较多", "energy_level": "高",
        "description": "阳光开朗的金毛，笑起来超治愈。训练度高，会握手、坐下、趴下。非常适合有院子的家庭。",
        "tags": ["金毛", "温顺", "适合家庭"], "image": DOG_IMAGES[0], "owner_id": 2,
    },
    {
        "name": "小黑", "species": "拉布拉多犬", "age": 1,
        "is_shedding": "中等", "energy_level": "高",
        "description": "黑色拉布拉多，聪明易训，已完成基础服从训练。活力十足，每天需要充分的户外运动。",
        "tags": ["聪明", "易训练", "运动型"], "image": DOG_IMAGES[1], "owner_id": 2,
    },
    {
        "name": "棉花糖", "species": "萨摩耶犬", "age": 2,
        "is_shedding": "非常多", "energy_level": "高",
        "description": "微笑天使萨摩耶，雪白毛发笑容永远在线。非常粘人，每天要大量运动，换毛期需要勤打扫。",
        "tags": ["萨摩耶", "微笑", "粘人"], "image": DOG_IMAGES[2], "owner_id": 2,
    },
    {
        "name": "豆沙", "species": "柯基犬", "age": 3,
        "is_shedding": "较多", "energy_level": "中等",
        "description": "屁股最迷人的柯基！腿短但步伐矫健，喜欢奔跑。会'弹跳步'，看着超级搞笑可爱。",
        "tags": ["柯基", "短腿", "可爱"], "image": DOG_IMAGES[3], "owner_id": 2,
    },
    {
        "name": "毛毛", "species": "博美犬", "age": 2,
        "is_shedding": "较多", "energy_level": "活跃",
        "description": "毛茸茸的小球，但性格一点不软！脾气倔强，认定了主人就非常忠诚。小型犬适合公寓饲养。",
        "tags": ["博美", "小型", "忠诚"], "image": DOG_IMAGES[4], "owner_id": 2,
    },
    {
        "name": "大壮", "species": "德国牧羊犬", "age": 4,
        "is_shedding": "较多", "energy_level": "高",
        "description": "警犬血统，已完成高级训练。忠诚护主，对陌生人保持警惕。需要有经验的主人和充足的活动空间。",
        "tags": ["护主", "高级训练", "有经验主人"], "image": DOG_IMAGES[5], "owner_id": 6,
    },
    {
        "name": "花生", "species": "比格犬", "age": 2,
        "is_shedding": "适量", "energy_level": "高",
        "description": "嗅觉猎犬，好奇心爆棚，每次出门都要把每棵树都闻遍。活泼开朗，爱和小孩子玩。",
        "tags": ["比格", "好奇", "亲小孩"], "image": DOG_IMAGES[6], "owner_id": 2,
    },
    {
        "name": "奥利奥", "species": "边境牧羊犬", "age": 3,
    ...
    {
        "name": "冰淇淋", "species": "哈士奇", "age": 2,
        "is_shedding": "非常多", "energy_level": "极高",
        "description": "二哈本哈，拆家届的老前辈。但颜值超高，蓝眼睛特别迷人。需要主人有强大的心理素质。",
        "tags": ["哈士奇", "高颜值", "精力充沛"], "image": DOG_IMAGES[8], "owner_id": 2,
    },
    {
        "name": "豆腐", "species": "泰迪犬", "age": 1,
        "is_shedding": "少", "energy_level": "中等",
        "description": "棕色泰迪，不掉毛，对过敏人群友好。经过专业修剪造型可爱，适合公寓饲养。",
        "tags": ["泰迪", "不掉毛", "低过敏"], "image": DOG_IMAGES[9], "owner_id": 2,
    },
    {
        "name": "小白", "species": "西高地白梗", "age": 3,
        "is_shedding": "少", "energy_level": "中等",
    ...
    {
        "name": "葡萄", "species": "迷你雪纳瑞", "age": 4,
        "is_shedding": "少", "energy_level": "中等",
        "description": "迷你雪纳瑞，胡须标志性。不掉毛，活泼但不过分吵闹，非常适合公寓家庭，警觉性高。",
        "tags": ["雪纳瑞", "不掉毛", "公寓友好"], "image": DOG_IMAGES[2], "owner_id": 2,
    },
    {
        "name": "咕噜", "species": "法国斗牛犬", "age": 3,
        "is_shedding": "少", "energy_level": "低",
        "description": "法斗，懒洋洋的小胖子。打呼噜的声音超级治愈，活动量不大，非常适合都市公寓生活。",
        "tags": ["法斗", "慵懒", "公寓友好"], "image": DOG_IMAGES[3], "owner_id": 2,
    },
    {
        "name": "珍珠", "species": "贵宾犬", "age": 2,
        "is_shedding": "少", "energy_level": "中等",
        "description": "标准贵宾，卷毛不掉毛。聪明易训，会很多才艺。性格友好，与小孩和老人都能相处融洽。",
        "tags": ["贵宾", "聪明", "不掉毛", "亲人"], "image": DOG_IMAGES[4], "owner_id": 6,
    },
]
...
POSTS = [
    ...
    {
        "title": "今天的饼干又胖了一点点",
        "content": "称了下体重，英短又长了0.2kg……兽医说要控食了，但它那可怜巴巴的眼神我真的受不了 😭 有没有好用的猫咪自动喂食器推荐？",
        "type": "daily", "user_idx": 3, "likes": 42, "image_idx": 0,
        "days_ago": 1,
    },
    {
        "title": "金毛第一次下海，反应把我笑死了",
        "content": "带球球去海边玩，以为它会很喜欢水，结果第一个浪打来直接跑路……后来慢慢才敢靠近，最后还是玩得很开心！分享几张照片给大家",
        "type": "daily", "user_idx": 4, "likes": 87, "image_idx": 1,
        "days_ago": 2,
    },
    {
        "title": "橘猫语录：食物是第一生产力",
        "content": "每次我进厨房，不管睡多死，小虎一定第一个到场。它就坐在那里用眼神审判我，意思是'你要是不给我吃的就等着'。今天终于拍到了这神情，哈哈哈",
    ...
    {
        "title": "猫咪把我新买的耳机咬断了……",
        "content": "600块的耳机，就这么没了。它咬断之后还若无其事地在旁边舔爪子。我气到想还它，但看见那张脸又气不起来……宠物真的是人类的天敌",
        "type": "daily", "user_idx": 3, "likes": 318, "image_idx": 4,
        "days_ago": 5,
    },
    {
        "title": "萨摩耶换毛季求生指南",
        "content": "棉花糖又开始换毛了，今天打扫出来的毛能织一件毛衣……整理了几个心得：①每天梳毛20分钟 ②多补充ω3 ③买一个好吸力的宠物吸尘器，真的救命",
        "type": "daily", "user_idx": 4, "likes": 95, "image_idx": 5,
        "days_ago": 4,
    },
    {
        "title": "三岁布偶猫，还是那么黏人",
        "content": "布丁今天又来占领我的键盘，我打字它就把脑袋怼过来，一副'你不理我我就给你添乱'的态度。爱了爱了，工作效率为零但心情好极了",
    ...
    {
        "title": "边牧飞盘训练记录第30天",
        "content": "奥利奥的飞盘技术越来越好了！今天练习了单手接盘，成功率达到了80%。分享一下训练日志：第一周先练习衔取，第二周引入飞盘目标，第三周开始抛接……",
    ...
    {
        "title": "领养前你需要了解的10件事",
        "content": "作为已经领养过3只猫的'老鸟'，总结了几点新手必看：\n1. 领养不冲动，充分了解该宠物的性格\n2. 提前准备好基础物资\n3. 给新猫/狗至少2周的适应期\n4. 不要因为不融合就退回\n5. 做好长达15年的陪伴准备……",
    ...
    # 公益活动 (charity)
    {
        "title": "【公益】本周末社区流浪猫绝育活动",
        "content": "本周六上午9点到12点，在朝阳区望京社区活动中心开展流浪猫TNR（诱捕-绝育-放归）活动。需要志愿者参与协助，提供专业兽医上门支持。有意愿的朋友请私信报名！",
    ...
    {
        "title": "感谢所有参与领养节活动的朋友",
        "content": "上周末的'缘分领养节'圆满结束！共有18只猫咪和12只狗狗找到了新家。特别感谢现场志愿者团队、赞助商、以及每一位来咨询的朋友。即使没有领养，来了解和学习也很重要❤️",
        "type": "charity", "user_idx": 6, "likes": 521, "image_idx": 10,
        "days_ago": 9,
    },
    {
        "title": "用AI智能分诊拯救了我的猫——真实经历分享",
        "content": "上周凌晨2点，猫咪突然开始一直用力蹲厕所但没有尿出来。我用了平台的AI分诊功能，系统直接判定为'紧急就医'并说明可能是尿路堵塞。我立刻去了24小时宠物医院，确诊了！医生说再晚几小时可能会引发肾衰竭。真的太感谢这个功能了",
...
ANNOUNCEMENTS = [
    {
        "title": "🎉 平台上线1周年 | 感谢1000+用户的陪伴",
        "content": "智慧宠物领养平台正式运营满一年！截至目前，已帮助超过300只流浪动物找到了新家，完成智能分诊咨询2000余次，营养方案生成500+份。感谢每一位用户的信任与支持！",
        "is_hot": 1,
        "date": (datetime.now() - timedelta(days=3)).strftime("%Y-%m-%d"),
    },
    {
        "title": "【新功能】AI营养专家上线，支持方案再规划",
        "content": "全新AI营养专家功能正式上线！根据您宠物的具体情况生成个性化营养方案，并支持根据7天反馈进行智能再规划。快去'智能喂养'页面试试吧！",
        "is_hot": 1,
    ...
    {
        "title": "【活动】3月领养节，领养费全免",
        "content": "3月15日-3月31日，参与本次领养节活动的宠物领养费全部减免！仅需通过资质审核即可领养心仪的毛孩子。名额有限，先到先得。",
        "is_hot": 1,
        "date": (datetime.now() - timedelta(days=1)).strftime("%Y-%m-%d"),
    },
    {
        "title": "系统维护通知 | 3月20日凌晨2-4点",
        "content": "平台将于3月20日凌晨2:00-4:00进行系统维护升级，届时服务将短暂不可用。维护期间产生的数据将在恢复后自动同步。给您带来的不便敬请谅解。",
        "is_hot": 0,
...
def seed(clear_existing=False):
    ...
    for pid in adopted_ids[:2]:
        cur.execute("UPDATE pets SET status='已领养' WHERE id=?", (pid,))
    conn.commit()
    ...
    # ── 6. 领养申请（模拟几条）───────────────────────────────────────────────
    print("填充领养申请...")
    cur.execute("SELECT id FROM pets WHERE status='待领养' LIMIT 10")
    available_pets = [r[0] for r in cur.fetchall()]
    statuses = ["待审核", "待审核", "通过", "通过", "不通过"]
    reasons = [
...
if __name__ == "__main__":
    ...
    parser.add_argument("--clear", action="store_true", help="清除已有数据后重新填充")
